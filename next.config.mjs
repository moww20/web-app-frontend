    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Content-Security-Policy', value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.vercel-insights.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: blob: https://raw.githack.com https://raw.githubusercontent.com https://*.walletconnect.com https://images.walletconnect.com https://registry.walletconnect.com; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https://api.coingecko.com https://*.vercel-insights.com https://api.web3modal.org https://pulse.walletconnect.org https://*.walletconnect.com wss://*.walletconnect.com https://cca-lite.coinbase.com https://raw.githack.com https://raw.githubusercontent.com; frame-src 'self' https://*.walletconnect.com https://*.coinbase.com; frame-ancestors 'none'; object-src 'none'; base-uri 'self'" },
